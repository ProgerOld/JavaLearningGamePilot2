package com.example.javalearninggamepilot2.entity;
...
import com.example.javalearninggamepilot2.GameView;
import com.example.javalearninggamepilot2.R;
...
public class Flight {
    ...
    //private boolean isGoingDown = false; // направление движения самолёта (true - вниз, false - вверх)
